...
- optimal value function $V^*=max_\pi E_{a~\pi}[R(\tau)\|s_0=s]$
- optimal action-value function $Q^*(s,a)=max_\pi E_{a~\pi}[R(\tau)\|s_0=s, a_0=a]$
...
- $V^\pi(s)=E[G_t\|s_t=s]=E[r_t+\gamma*G_{k+1}\|s_t=s]=E[r_t+\gamma*E[G_{k+1}\|s_t=s]\|s_t=s]=E[r_t+\gamma*V^\pi(s_{k+1})\|s_t=s]$
- $G^\pi(s)=E[G_t\|s_t=s, a_t=a]=E[r_t+\gamma*G_{k+1}\|s_t=s, a_t=a]=E[r_t+\gamma*E[G_{k+1}\|s_t=s, a_t=a]\|s_t=s, a_t=a]$
- 
